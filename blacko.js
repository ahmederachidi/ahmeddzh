...
client.on("message", message => {
 ...
 if (message.content === "^^help") {
  ...
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .addField("『blacko Bot』 『اسم البوت』", true)
      
      .addField("『مصمم البوت: Ahmed_BlaCko#9170』
      
      .addField("『^help^』😘『اذا تبي جميع الاوامر 』😵", true)
...
if (message.content === '^^support') {
      message.author.send(' |Ahmed_BlaCko#9170| لـ أي استفسار').catch(e => console.log(e.stack));
...
if (message.content === '^^invite') {
      message.author.send(' رابط البوت |  https://discordapp.com/api/oauth2/authorize?client_id=483294951388610580&permissions=8&scope=bot
    }
   } 
  });
...
client.login('NDgzMjk0OTUxMzg4NjEwNTgw.DmrlrQ.oyOF-TcEWhf-X8O2tJdA0WrT3X8');
